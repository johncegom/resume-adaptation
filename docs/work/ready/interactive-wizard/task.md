...
- [ ] RAFT0013: Implement process spinner and progress loader
...
- [ ] RAFT0014: Implement review and manual editing terminal view
...
- [ ] RAFT0015: Add Cobra CLI `adapt` command router
