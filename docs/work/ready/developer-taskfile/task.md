...
- [ ] RAFT0033: Add tidy, clean, and developer setup tasks to Taskfile.yml
...
- [ ] RAFT0034: Add documentation and verify Taskfile execution on current workspace
